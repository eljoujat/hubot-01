...
class SkypeWebAdapter extends Adapter
    ...
    phantom.create ((ph) ->
      ph.createPage (page) ->
        ...
        page.open 'https://web.skype.com/', (status) ->
          ...
          self.robot.logger.error 'username ----> '+self.username
          self.robot.logger.error 'password ----> '+self.password
  ...
  #
  onEventMessage: (msg) ->
    #self.robot.logger.error 'New Message ----> '+msg.resource.content
    if (msg.resourceType is 'NewMessage' and
      ...
      console.log('Message too long for sending! Splitting...'+msg.resource.content)
